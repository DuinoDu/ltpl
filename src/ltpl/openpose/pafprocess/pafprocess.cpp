...
//    const double THRESH_PAF = 0.40;
    ...
    //for (int part_id = 0; part_id < NUM_PART; part_id ++) {
    //  std::cout << "part_id: " << part_id<< ", peak sum: " << peak_infos[part_id].size() << std::endl;
    //}
    ...
    for (int pair_id = 0; pair_id < COCOPAIRS_SIZE; pair_id ++) {
        ...
        //std::cout << "peak_a" << std::endl;
        //for (Peak peak :peak_a_list){
        //  std::cout << peak.x << ", "<< peak.y << std::endl;
        //}
        //std::cout << "peak_b" << std::endl;
        //for(auto peak : peak_b_list){
        //  std::cout << peak.x << ", "<< peak.y << std::endl;
        //}
        ...
        for (int peak_a_id = 0; peak_a_id < (int) peak_a_list.size(); peak_a_id ++) {
            ...
            for (int peak_b_id = 0; peak_b_id < (int) peak_b_list.size(); peak_b_id ++) {
                ...
                // criterion 2 : score threshold count
                float criterion2 = scores / STEP_PAF + min(0.0, 0.5 * h1 / norm - 1.0);

                //std::cout << "criterion1: " << criterion1 << std::endl;
                //std::cout << "criterion2: " << criterion2 << std::endl;
...
vector<VectorXY> get_paf_vectors(float *pafmap, 
    const int& ch_id1, const int& ch_id2, int& f2, int& f3, 
